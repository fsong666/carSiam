...
from carsot.utils.lr_scheduler import build_lr_scheduler
from carsot.utils.log_helper import init_log, print_speed, add_file_handler
from carsot.utils.distributed import dist_init, reduce_gradients,\
        average_reduce, get_rank, get_world_size
from carsot.utils.model_load import load_pretrain, restore_from
from carsot.utils.average_meter import AverageMeter
    ...
    if rank == 0:
        ...
        if cfg.TRAIN.LOG_DIR:
            add_file_handler('global',
                             ...
                             logging.INFO)
            add_file_handler('global',
                             os.path.join(cfg.TRAIN.LOG_DIR, 'logs_size.txt'),
                             logging.WARNING)
