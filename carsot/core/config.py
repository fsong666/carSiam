...
__C.DATASET.NAMES = ('ODS', 'VID', 'COCO', 'DET', 'YOUTUBEBB')

__C.DATASET.ODS = CN()
__C.DATASET.ODS.ROOT = 'train_dataset/ods/crop511'          # ODS dataset path
__C.DATASET.ODS.ANNO = 'train_dataset/ods/train.json'
__C.DATASET.ODS.FRAME_RANGE = 100
__C.DATASET.ODS.NUM_USE = 100000
