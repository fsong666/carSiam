...
class SiameseTracker(BaseTracker):
    def get_subwindow(self, im, pos, model_sz, original_sz, avg_chans):
        ...
        args:
            im: bgr based image
            pos: center position of bbox
            model_sz: exemplar size 127 or 255
            s_z: original size  s_z or s_x, s_z != 127, s_x != 255
        ...
        sz = original_sz
        im_sz = im.shape
        c = (original_sz + 1) / 2  # c ==41.5 != center of bbox
        # print('c={}, center[0]:{}'.format(c, pos))
        # search和template框的坐标最小最大值
